namespace LibraryExample.UnitTests
{
	...
	public class PersonnUnitTest
	{
		...
		public void ShouldDelete()
		{
			...
			testDatabaseModel.GetPeople().ElementAt(2).Delete();
		...
		public void ShouldGetDeliveryAddress()
		{
			...
			testDatabaseModel = new TestDatabaseModel(Utils.CreateTestDatabase());
			address=testDatabaseModel.GetPeople().ElementAt(0).GetDeliveryAddress();
		...
		public void ShouldGetBillingAddress()
		{
			...
			testDatabaseModel = new TestDatabaseModel(Utils.CreateTestDatabase());
			address = testDatabaseModel.GetPeople().ElementAt(0).GetBillingAddress();
		...
		public void ShouldNotGetBillingAddress()
		{
			...
			testDatabaseModel = new TestDatabaseModel(Utils.CreateTestDatabase());
			address = testDatabaseModel.GetPeople().ElementAt(2).GetBillingAddress();
